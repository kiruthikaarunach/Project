...
public class TST<Value> {
    ...
    static Hashtable<String, String> URLList = new Hashtable<String, String>();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // String[] keys = {"she","sells","sea","shells","by","the","sea","shore","shells"};
            //String[] keys = {"she", "sells", "sea", "shells", "by", "the", "sea", "shore", "shells"};

            String folderPath = ".src/main/resources/text_files/";
            File folder = new File(folderPath);
            File[] files = folder.listFiles();
            TST<Integer> st;
            //String key = "python"; // TODO - get the right word to search from edit distance output
            ...
            for (int file = 0; file < files.length; file++) {
                ...
                while ((line = in.readLine()) != null) {
                    ...
                    //  keys = new String[stringTokenizer.countTokens()];
                    ...
                    while (stringTokenizer.hasMoreTokens()) {
                        ...
                        if (str != null) {
                            //  keys[x] = String.copyValueOf(str.toCharArray());
                            if (st.get(str) == null)
                                st.put(str, 1);
                            else
                ...
                totFiles++;
                FileList.put(String.valueOf(files[file]), wordFreq);
                // print value of a key
                String fileName = files[file].getName();
                StdOut.println("key = " + key + " has " + wordFreq + " occurences in file " + files[file].getName());
                System.out.println(URLList.get(URLList1.get(fileName)));
                totwordFreq+=wordFreq;
                wordFreq = 0;//reset the word
            }

            System.out.println("Total number of words \"" + key + "\" " + "in " + totFiles + " txt files = " + totwordFreq );
        }
        catch(Exception e) {
