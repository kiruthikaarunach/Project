...
public class SearchEngine {
	...
	static String folderPath = "D:/idea/idea workspace/acc-final-project/src/resources/htmlFiles/";

	Hashtable<String, String> URLList = new Hashtable<String, String>();

	public void webSearchEngine() throws Exception {
	...
	private String searchWord(String url) {
		...
		for (String crawledURL : URL) {
			try{System.out.println("Crawled URL: " + crawledURL);
				...
				htmLtoText.parseFilesInFolder(folderPath);
			}
		}htmLtoText.parseFilesInFolder(folderPath);
	...
	private void saveCrawledHTML(String url) {
		try {
			...
			FileOutputStream fileOutputStream = new FileOutputStream("./src/resources/htmlFiles/" + fileName);
